...
public class CreateAccountActivityTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CreateAccountActivityTwo.this,CreateAccountActivityThree.class);
